...
import { CallAssignmentStatus } from '../../api-call/api';
...
const AssignmentStatus = () => {
    ...
    // Get assignment status Api
    const GetAssignmentStatus = async () => {
        try {
            const { response, jsonResponse, error } = await CallAssignmentStatus();
    ...
    // Handle assignment status menu toggle
                ...
                <div className='bg-white mt-4 mb-5 px-3 rounded-lg lookupsContiner'>
                    <div className="flex items-center">
                        <div className="flex items-start ps-1 pt-3 w-full lookupContainerListTittleDiv">
                            <h2 className='pe-2 pb-2 w-full font-semibold text-gray-700'>10. Assignment Status</h2>
                                ...
                                status.map((element, index) => (
                                    <div key={index} className="pt-3">
                                        <div className="flex items-center p-2 border-b border-b-gray-300 rounded w-full">
                                            ...
                                            {/* <div className='flex justify-end lookupActionIconDiv'>
                                                <CiMenuKebab onClick={() => toggleStatusMenu(index)} className='text-black text-xl cursor-pointer' />
                                            </div> */}
